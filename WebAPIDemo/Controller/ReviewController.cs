...
namespace WebAPIDemo.Controller
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateCountry([FromQuery] int reviewerId,[FromQuery] int pokeId,[FromBody] ReviewDto reviewCreate)
        {
        ...
        public IActionResult UpdateCountry(int reviewId, [FromBody] ReviewDto reviewUpdate)
        {
            ...
            var reviewerMap = _mapper.Map<Review>(reviewUpdate);
